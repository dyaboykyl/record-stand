...
//     TFT_DE, TFT_VSYNC, TFT_HSYNC, TFT_PCLK, TFT_R1, TFT_R2, TFT_R3, TFT_R4, TFT_R5, TFT_G0,
//     TFT_G1, TFT_G2, TFT_G3, TFT_G4, TFT_G5, TFT_B1, TFT_B2, TFT_B3, TFT_B4, TFT_B5, 1 /*
//     hync_polarity */, 46 /* 46hsync_front_porch */, 2 /* hsync_pulse_width */, 44 /*
//     44hsync_back_porch */, 1 /* vsync_polarity */, 50 /* 50vsync_front_porch */, 16 /*
//     vsync_pulse_width */, 16 /* vsync_back_porch */);
...
// #define DRAW_BUF_SIZE DIS_WIDTH_PX  //(DIS_WIDTH_PX *DIS_HEIGHT_PX / 10 * (LV_COLOR_DEPTH / 8))
// uint32_t draw_buf[DRAW_BUF_SIZE * 10];
// uint32_t draw_buf2[DRAW_BUF_SIZE * 10];
...
// void background() { lv_obj_set_style_bg_color(lv_screen_active(), lv_color_black(), 0); }
