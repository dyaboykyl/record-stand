...
i2s_pin_config_t i2sPins = {
    .bck_io_num = A1, .ws_io_num = SS, .data_out_num = I2S_PIN_NO_CHANGE, .data_in_num = A0};
...
AudioData* readI2sAudio() {
  size_t bytes_read = 0;
  i2s_read(I2S_NUM_0, i2sData.samples, sizeof(int16_t) * SAMPLE_BUFFER_SIZE, &bytes_read,
           portMAX_DELAY);
